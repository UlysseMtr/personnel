...
class TestEmploye {
	...
	{
		  Ligue ligue = gestionPersonnel.addLigue("Football");
		  Employe employe = ligue.addEmploye("Bouchard", "Gérard", "g.bouchard@gmail.com", "azerty", LocalDate.of(2023, 12, 31), LocalDate.of(2024, 1, 1));
	...
	void testSetDateArriveInvalid() throws SauvegardeImpossible, ExceptionDate 
	{
		Ligue ligue = gestionPersonnel.addLigue("Fléchettes");
		Employe employe = ligue.addEmploye("Bouchard", "Gérard", "g.bouchard@gmail.com", "azerty", LocalDate.of(2023, 1, 1), LocalDate.of(2023, 12, 31));
		Exception erreur = assertThrows(ExceptionDate.class, () -> employe.setDateArrivee(LocalDate.of(2024, 1, 1)));
